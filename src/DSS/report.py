...
from scoring import InterventionScore
...
def build_report(
    ...
    Args:
        ...
        model_confidence:    ResNet-50 softmax confidence (0.0–1.0).
        rag_context:         Retrieved treatment text from Lab 4 ChromaDB.
...
if __name__ == "__main__":
    ...
    report = build_report(
        ...
        rag_context="Apply chlorothalonil fungicide at 7-day intervals.",
        rag_relevance=0.87,
